          ...
          <div>
            ...
            >
              <p className="my-2 text-sm md:text-base">
                ...
                просто! Вам на помощь спешит супергерой – Where Pizza! Как у
                всякого супергероя, у Where Pizza есть свои суперсилы:
              ...
              <p className="mt-1 mb-2 text-base">
                Доставка пиццы от Where Pizza – это когда Вам не нужно никуда ехать
                ...
                пиццерии Where. И не забудьте оплатить заказ курьеру!
              </p>
            </div>
